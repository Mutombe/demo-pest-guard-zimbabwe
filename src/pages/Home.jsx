        ...
        <div className="grid lg:grid-cols-5 gap-12 items-center min-h-[65vh]">
          <div className="lg:col-span-3">
            ...
            <div className="overflow-hidden">
              <motion.h1 initial={{ y: '100%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.4, ease: [0.16, 1, 0.3, 1] }}
                ...
                FROM INFESTED<br />TO <span className="text-teal-600 italic font-bold">PROTECTED</span>
              </motion.h1>
            </div>
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9 }}
              className="text-gray-500 text-sm leading-relaxed mt-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
              Our proven 4-step process: Inspect, Treat, Prevent, Monitor. Every property receives a tailored plan backed by our satisfaction guarantee.
            </motion.p>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.1 }} className="flex flex-wrap gap-4 mt-8">
              ...
              <a href={`tel:${business.phoneRaw}`} className="group inline-flex items-center gap-3 border border-gray-300 text-gray-600 px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-teal-500 hover:text-teal-600 transition-all" style={{ fontFamily: 'var(--font-sans)' }}>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.9, delay: 0.3 }} className="lg:col-span-2 relative">
            <div className="overflow-hidden aspect-[3/4]">
              <img src={heroImages[0]} alt="Before and after pest treatment" className="w-full h-full object-cover object-center" loading="eager" />
            </div>
            <div className="absolute -bottom-4 -left-4 bg-teal-600 text-white p-5 shadow-xl z-10">
              <div className="text-center">
                <CheckCircle size={24} weight="fill" className="text-teal-200 mx-auto mb-1" />
                <div className="text-[9px] uppercase tracking-[0.2em]" style={{ fontFamily: 'var(--font-sans)' }}>100% Safe</div>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The PEST<br /><span className="text-teal-500">Story</span>
            </h2>
            {about.story.map((p, i) => (
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <h2 className="font-heading text-gray-900 leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-teal-500">PEST</span>
            </h2>
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={siteData.hero.backgroundImages[0]?.url} alt="PEST GUARD ZIMBABWE" className="w-full h-[130%] object-cover object-center" loading="lazy" />
