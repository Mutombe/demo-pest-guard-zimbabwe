...
const siteData = {
  business: {
    name: "PEST GUARD ZIMBABWE",
    legalName: "PEST GUARD ZIMBABWE",
    tagline: "Professional Cleaning & Pest Control Solutions",
    description: "PEST GUARD ZIMBABWE was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
    phone: "+263 77 592 5916",
    phoneRaw: "+263775925916",
    whatsappNumber: "263775925916",
    email: "info@pestguardzimbabwe.co.zw",
    ...
    cookieConsentKey: "pest-guard-zimbabwe-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "PEST", logoLine2: "GUARD ZIMBABWE" },

  hero: {
    badge: "Professional Cleaning & Pest Control in Harare",
    titleParts: [
      { text: "PROTECTING " },
      { text: "YOUR SPACE", highlight: true },
      { text: " 24/7." },
    ],
  ...
  homeTestimonials: [
    { text: "PEST GUARD ZIMBABWE transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
    { text: "We had a serious cockroach problem. PEST GUARD ZIMBABWE came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Professional, punctual, and incredibly thorough. PEST GUARD ZIMBABWE handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "PEST GUARD ZIMBABWE was founded on a simple principle: every space deserves to be clean, safe, and healthy. We bring professional-grade cleaning and pest control to homes and businesses across Harare.",
  ...
  reviews: {
    ...
    items: [
      { text: "PEST GUARD ZIMBABWE transformed our office. The deep clean was so thorough our staff thought we had renovated. Absolutely outstanding work.", name: "Patricia Makoni", role: "Office Manager", rating: 5 },
      { text: "We had a serious cockroach problem. PEST GUARD ZIMBABWE came in, treated the entire property, and we have not seen a single pest since. Highly recommend.", name: "David Chikwanha", role: "Homeowner, Borrowdale", rating: 5 },
      { text: "Professional, punctual, and incredibly thorough. PEST GUARD ZIMBABWE handles all our commercial cleaning and the standard is always impeccable.", name: "Nyasha Mhembere", role: "Property Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. PEST GUARD ZIMBABWE exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend PEST GUARD ZIMBABWE to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at PEST GUARD ZIMBABWE is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. PEST GUARD ZIMBABWE has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi PEST GUARD ZIMBABWE! I would like to request a quote.",
